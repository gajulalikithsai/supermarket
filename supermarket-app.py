...
items = {
    "basmati rice": 30, "brown rice": 20,
    "idli rice": 18, "tea powder": 15, "coffee powder": 13,
    "sugar": 1, "health drink": 19, "green tea": 35, "atukulu": 15,
    ...
    "dish wash cleaner": 56, "toothpaste": 33, "shampoo": 40,
    "soaps": 56
}
...
for item in items.keys():
    option1 = int(input(("**IF YOU WANT TO BUY PRESS 1 (OR) EXIT FOR 2**: ")))
    if option1 == 2:
        break
    if option1 == 1:
        ...
        if item in items.keys():
            ...
            s_items.append((item, quantity, price))
            totalprice += price
            ilist.append(item)
...
if inp == "yes":
    ...
    print(80 * "-")
    print(30 * " ", "!!THANKING YOU VISIT AGAIN!!")
    print(80 * "-")
    print("!!THANK YOU !!")
    print("VISIT AGAIN !!")
